...
main() {
  ...
  doppler -v || (echo "Install doppler cli: https://docs.doppler.com/docs/install-cli" && exit 0)

  echo "# Autogenerated by doppler.sh" > ".env"

  doppler setup --no-interactive --project awesome-italia-opensource

  set_password "awesome-italia-opensource" "production"
}
